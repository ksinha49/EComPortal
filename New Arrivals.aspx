<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="New Arrivals.aspx.cs" Inherits="New_Arrivals" %>
...
<table style="padding-left:0px">
   ...
   <td>
   <div><asp:SqlDataSource ID="SqlDataSource4" runat="server" 
ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
SelectCommand="SELECT [ProductID], [Name], [Description], 
               [Price], [ImageUrl] FROM [productnew]">
</asp:SqlDataSource>
  </div>
...
PostBackUrl='<%# Eval("ProductID","Productdetail8.aspx?ProductID={0}") %>' />
<br />
