<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Fashionkid.aspx.cs" Inherits="Fashionkid" %>
...
SelectCommand="SELECT [ProductID], [Name], [Description], 
               [Price], [ImageUrl] FROM [productfashion3]">
</asp:SqlDataSource>
</div>
...
PostBackUrl='<%# Eval("ProductID","Productdetail4.aspx?ProductID={0}") %>' />
<br />
